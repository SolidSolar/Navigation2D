...
namespace Navigation
{
    ...
    public class VertexComparer : IComparer<Vertex>
    {
        ...
        {
            var a1 = Util.CalculateAngle(Vector2.right, x.Position - Reference);
            var a2 = Util.CalculateAngle(Vector2.right, y.Position - Reference);
    ...
    public static class Util
    {
        ...
        {
            var sign = from.x * to.y - from.y * to.x < 0;
